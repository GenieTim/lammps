...
/* ----------------------------------------------------------------------
   Contributing author: Tim Bernhard (ETH Zürich)
------------------------------------------------------------------------- */
...
void PairDPDConservative::init_style()
{
...
void PairDPDConservative::write_data(FILE *fp)
{
...
void PairDPDConservative::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
